...
/* 有关任务们/陷阱门/中断门,详情参考pm.inc或者资料库中于渊和赵炯老师的书 */
typedef struct s_gate
{
	u16	offset_low; 		/* offset低16位 */
	u16	selector;			/* 选择子 */
	u8	dcount;			/* ParameterCount(3)  -----*/
	u8	attr;				/* P（1） DPL（2） DT(1) TYPE(4) */
	u16	offset_high;		/* offset高16位 */
}GATE;
...
/* 宏 */
/* 这个是组合线性地址的过程 */
#define vir2phys(seg_base, seg_off)	(u32)(((u32)seg_base) + (u32)(seg_off))
